...
//    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == login_button) {
            ...
            UserDatabase database = loginController.callCreateDatabase();
            if (loginController.call_valid_login(database, username_value, pass_value)) {
...
//        username_label = new JLabel();
//        username_label.setText("Username:");
//        username_label.setBounds(500,500,200,40);
//        username_label.setFocusable(false);
//        textField1 = new JTextField(15);
//        textField1.setBounds(700,500,200,40);
//        textField1.setFocusable(false);
//
//        pass_label = new JLabel();
//        pass_label.setText("Password:");
//        pass_label.setBounds(100,600,200,40);
//        pass_label.setFocusable(false);
//        textField2 = new JTextField(15);
//        textField2.setBounds(100,600,200,40);
