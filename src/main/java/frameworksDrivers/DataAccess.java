...
public class DataAccess {
    ...
    public void readCSV() {
        ...
        try
        {
            BufferedReader br = new BufferedReader(new FileReader("/C:/csc207/programming exercises/" +
                    "course-project-wanna-date/src/main/java/frameworksDrivers/database.csv"));
            br.readLine();
